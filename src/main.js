...
import { faStar, faDatabase, faArrowRight, faMountain, faChevronDown } from '@fortawesome/free-solid-svg-icons'
...
library.add(faStar, faGithub, faInstagram, faDribbble, faDatabase, faVuejs, faLinux, faHtml5, faNodeJs, faGitAlt, faAdobe, faPython, faArrowRight, faMountain, faChevronDown)
